...
import university.misv2.universitymisv2.student.User;
...
public class Attendance {
    ...
    public Attendance(Integer id, String student_id, String course_code, java.util.Date Date, String theory_or_Practical, String status) {
        this.id = id;
