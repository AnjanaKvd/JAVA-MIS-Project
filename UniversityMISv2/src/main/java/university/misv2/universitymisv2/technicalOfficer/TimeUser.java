...
public class TimeUser {
    ...
    public TimeUser(int timetable_id, String course_code, String course_name, String lecturer, String classroom, String day_of_week, String start_time, String end_time) {
    ...
    public static List<TimeUser> fetchAllUsers()  {
        List<TimeUser> timeUser = new ArrayList<>();
        ...
        try (Statement statement = connectDB.createStatement();
            ...
            while (result.next()) {
                ...
                TimeUser timeuser = new TimeUser(timetable_id,course_code,course_name,lecturer,classroom,day_of_week,start_time,end_time);
                timeUser.add(timeuser);
            }
